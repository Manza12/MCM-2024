...
t_alberti = Texture(
    Rhythm(Hit('0/8', '3/16')),
    Rhythm(Hit('2/8', '1/8')),
    Rhythm(Hit('3/16', '1/16'), Hit('3/8', '1/8')),
)

# Orquestration
o_harmony = Instrumentation(Section(Instrument('Woodblock'), Instrument('Steel Drums')),
                            Section(Instrument('Steel Drums')),
                            Section(Instrument('Melodic Tom'), Instrument('Steel Drums')))
...
steel_drums = Section(Instrument('Steel Drums'))
o_meoldy_1 = Instrumentation([steel_drums for _ in range(8)])
o_meoldy_2 = Instrumentation([steel_drums for _ in range(11)])
